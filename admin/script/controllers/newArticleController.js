...
// newArticleController.js

angular.module ('erich0929.controller')
	.controller ('newArticleController', ['$scope', 'categories', 'category', 'domain',
		function ($scope, categories, category, domain) {
	$scope.categories = categories;
	$scope.category = (function () {
		for (var i = 0; i < categories.length; i++) {
			if (categories [i].name == category) return categories [i];
		}
	}) ();	
